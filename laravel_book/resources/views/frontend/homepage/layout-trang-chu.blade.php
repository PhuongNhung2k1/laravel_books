...
<body>
    ...
    @include("frontend.layout.navbar-trangchu")
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;background-color:#ead0bc ;">
                    <p class="text-right">15 Products</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" height="100px" alt="">
                    </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <a href="{{ url('customer/products/detail/'.$product->id)}}"><img class="img-fluid w-100" src="{{ asset('upload/products/'.$product->photo) }}" alt=""></a>
                    </div>
