...
<body>
  <!--[if lt IE 8]>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                   <span style="color:#fff;margin-right: 10px">Wellcome to Admin Page</span><a href="index.html"><img src="{{asset('img/kinangsong2.jpg')}}" width="30px" height="30px" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                </i><a href="{{ url('admin/categories')}}"><i class="ti-palette"></i><span>Danh mục sản phẩm</span></a>
                            </li>
                             <li>
                                <a href="{{ url('admin/products')}}"><i class="ti-layers-alt"></i> <span>Danh sách sản phẩm</span></a>
                            </li>
                             <li>
                                <a href="{{ url('admin/news')}}"><i class="ti-layers-alt"></i> <span>Danh mục tin tức</span></a>
                            </li>
                             <li>
                                <a href="{{ url('admin/users')}}"><i class="ti-layers-alt"></i> <span>Danh sách Users</span></a>
                            </li>
                             <li>
                                <a href="{{ url('admin/orders')}}"><i class="ti-layers-alt"></i> <span>Danh sách đơn hàng</span></a>
                            </li>
                             <li>
                                <a href="{{ url('admin/logout')}}"><i class="ti-layers-alt"></i> <span>Đăng xuất</span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="{{ asset('img/ngontinh2.jpg') }}" alt="">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Admin Bookshop <i class="fa fa-angle-down"></i></h4>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Message</a>
                                <a class="dropdown-item" href="#">Settings</a>
                                <a href="{{ url('admin/logout')}}" class="dropdown-item" href="#">Log Out</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('srtdash-admin-dashboard-master/srtdash/assets/js/line-chart.js') }}"></script>
    <!-- all pie chart -->
    <script src="{{asset('srtdash-admin-dashboard-master/srtdash/assets/js/pie-chart.js') }}"></script>
    <!-- others plugins -->
