 ...
 <div class="col-12 mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ url('admin/users/create') }}" class="btn btn-primary">Add</a>
            ...
            <div class="data-tables datatable-primary">
                <table id="dataTable2" class="text-center">
                    <thead class="text-uppercase">
                            <tr class="table-info">
                            <th style="color:#000">STT</th>
                            <th style="color:#000">Name</th>
                            <th style="color:#000">Edit | Delete</th>
                            </tr>
                        </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    <ul class="d-flex justify-content-center">
                                        <li class="mr-3"><a href="{{url('admin/users/update/'.$rows->id)}}" class="text-secondary"><i class="fa fa-edit"></i></a></li>
                                        <li><a href="" class="text-danger" data-toggle="modal" data-target="#confim"><i class="ti-trash"></i></a></li>
                                        <!-- <li><a href="{{url('admin/users/delete/'.$rows->id)}}" class="text-danger" onclick="return window.confirm('Are you sure?');"><i class="ti-trash"></i></a></li> -->
                                    </ul>
                                </td>
                        </tr>
                   @endforeach
